...
/datum/anvil_recipe/weapons/steel/billhook
	name = "Билхук (+1 Маленькое полено)"
	req_bar = /obj/item/ingot/steel
	additional_items = list(/obj/item/grown/log/tree/small)
...
/datum/anvil_recipe/weapons/decsword
	name = "Церемониальный меч (+1 Золото)"
	req_bar = /obj/item/ingot/steel
...
/datum/anvil_recipe/weapons/decsword
	name = "Церемониальный меч (+1 Стальной меч)"
...
/datum/anvil_recipe/weapons/decrapier
	name = "Великолепная рапира (+1 Золото)"
	req_bar = /obj/item/ingot/steel
	additional_items = list(/obj/item/ingot/gold)
...
/datum/anvil_recipe/weapons/decrapier
	name = "Великолепная рапира (+1 Стальная рапира)"
	req_bar = /obj/item/ingot/gold
...
/datum/anvil_recipe/weapons/terminus
	name = "Терминус Эст (+1 Золотой слиток) (+1 Сталь) (+1 Ронц)"
	req_bar = /obj/item/ingot/gold
